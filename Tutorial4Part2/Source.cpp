 ...
 *  \details   The makeIdentityMatrix function is used to make the identity Matrix
               The isIdentityMatrix   function tests if Identiy Matrix exists
               The sumOfDiagonal      function counts the total sum of diagonal Matrix
               The sumofRows          function counts the total sum of rows in a Matrix
               The sumofRow           function counts the total sum of a row in a Matrix
               The fillWithRandomNum  function fills the matrix with random numbers
               The printMatrix        function prints a specific Matrix
